...
func (x *HelloWithIDRequest) Reset() {
	*x = HelloWithIDRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *HelloWithIDRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HelloWithIDRequest) ProtoMessage() {}

func (x *HelloWithIDRequest) ProtoReflect() protoreflect.Message {
	mi := &file_greeter_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HelloWithIDRequest.ProtoReflect.Descriptor instead.
func (*HelloWithIDRequest) Descriptor() ([]byte, []int) {
	return file_greeter_proto_rawDescGZIP(), []int{2}
}

func (x *HelloWithIDRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
var file_greeter_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x22, 0x24, 0x0a, 0x12, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x57, 0x69, 0x74, 0x68, 0x49,
	0x44, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x32, 0xbc, 0x01, 0x0a, 0x07, 0x47, 0x72, 0x65,
	0x65, 0x74, 0x65, 0x72, 0x12, 0x34, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f,
	...
	0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0d, 0x53, 0x61,
	0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x41, 0x67, 0x61, 0x69, 0x6e, 0x12, 0x13, 0x2e, 0x68, 0x65,
	...
	0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x40, 0x0a, 0x0e, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c,
	0x6f, 0x57, 0x69, 0x74, 0x68, 0x49, 0x44, 0x12, 0x19, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e,
	0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x57, 0x69, 0x74, 0x68, 0x49, 0x44, 0x52, 0x65, 0x71, 0x75, 0x65,
...
var file_greeter_proto_goTypes = []interface{}{
	...
	(*HelloWithIDRequest)(nil), // 2: hello.HelloWithIDRequest
}
var file_greeter_proto_depIdxs = []int32{
	...
	2, // 2: hello.Greeter.SayHelloWithID:input_type -> hello.HelloWithIDRequest
	1, // 3: hello.Greeter.SayHello:output_type -> hello.HelloReply
	1, // 4: hello.Greeter.SayHelloAgain:output_type -> hello.HelloReply
	1, // 5: hello.Greeter.SayHelloWithID:output_type -> hello.HelloReply
...
func file_greeter_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greeter_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HelloWithIDRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
